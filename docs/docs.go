...
var doc = `{
    ...
    "paths": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.FileDto"
                        }
                    }
                ],
                "responses": {
        ...
        "/file/{id}": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Project primaray id",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
        ...
        "/k3s/deployment/{namespace}/{name}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Specified name of deployment",
                        "name": "name",
                        "in": "path",
                        "required": true
                    },
        ...
        "/k3s/ingress/{namespace}/{name}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Specified name of Ingress",
                        "name": "name",
                        "in": "path",
                        "required": true
                    },
        ...
        "/k3s/namespace/{name}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Specified name of Namespace",
                        "name": "name",
                        "in": "query"
                    }
                ],
        ...
        "/k3s/pod/metrics/{id}/{namespace}/": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Selector label, read more here: https://stackoverflow.com/a/47453572",
                        "name": "prefix",
                        "in": "query"
                    },
                    {
        ...
        "/k3s/pod/metrics/{id}/{namespace}/{name}": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Specified name of the Pod",
                        "name": "name",
                        "in": "path",
                        "required": true
                    },
        ...
        "/k3s/pods/{namespace}/{name}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Specified name of Pod",
                        "name": "name",
                        "in": "path",
                        "required": true
                    },
        ...
        "/k3s/service/{namespace}/{name}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Specified name of Service",
                        "name": "name",
                        "in": "path",
                        "required": true
                    },
        ...
        "/link/list/{id}": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "List of Links info",
                        "name": "model",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.TokenEntity"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/project": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Name: 'CodeRain'",
                        "name": "name",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Title: 'Code Rain'",
                        "name": "title",
                        "in": "query"
                    },
                    {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Project without File Data",
                        "name": "model",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ProjectDto"
                        }
                    }
                ],
                "responses": {
        ...
        "/subscribe": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Small info about subscription for k3s",
                        "name": "model",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.SubscribeDto"
                        }
                    }
                ],
                "responses": {
        ...
        "/subscription": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "For more info about query see request: 'GET /operations'",
                        "name": "_",
                        "in": "query"
                    }
                ],
        ...
        "/subscription/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "This id can be a ID (Primary Key) or a CronID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.WorldDto"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.Metrics": {
            ...
            "properties": {
                ...
                "name": {
                    "type": "string",
                    "example": "void-deployment-8985bd57d-k9n5g"
                },
                "namespace": {
                    "type": "string",
                    "example": "void-deployment-8985bd57d-k9n5g"
        ...
        "models.Subscription": {
            ...
            "properties": {
                ...
                "cron_id": {
                    "type": "string",
                    "example": "d266389ebf09e1e8a95a5b4286b504b2"
                },
                "cron_time": {
                    "type": "string",
                    "example": "00 00 00 */1 * *"
