...
func NewPatternService(db *gorm.DB, client *redis.Client) *PatternService {
	return &PatternService{key: "LINK", db: db, client: client}
}

func (c *PatternService) isExist(model *m.Link) bool {
...
func (c *PatternService) precache(model *m.Link) {
...
func (c *PatternService) deepcache(models []m.Link, key string) interface{} {
	var suffix []string
...
func (c *PatternService) recache(model *m.Link, delete bool) {
...
func (c *PatternService) query(dto *m.LinkQueryDto, client *gorm.DB) (*gorm.DB, string) {
	var suffix []string
...
func (c *PatternService) Create(model *m.Link) error {
...
func (c *PatternService) Read(query *m.LinkQueryDto) ([]m.Link, error) {
	var model []m.Link
...
func (c *PatternService) Update(query *m.LinkQueryDto, model *m.Link) ([]m.Link, error) {
	var res *gorm.DB
	client, suffix := c.query(query, c.db)
...
func (c *PatternService) Delete(query *m.LinkQueryDto) (int, error) {
	var models []m.Link
	client, suffix := c.query(query, c.db)
